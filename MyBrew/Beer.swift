...
class Beer {
    ...
    convenience init?(withGlobalJson globalJson : [String : AnyObject]) {
        ...
        self.init(beerName: beerName, beerID: beerID, beerSRM: beerSRM, beerABV: beerABV, beerIBU: beerIBU, beerUrlString: beerURL, beerDescription: beerDescription, breweryName: nil,breweryLocation: nil)
   ...
   convenience init?(withJson json : [String : AnyObject]) {
    ...
    init(beerName: String, beerID: Int, beerSRM : Int, beerABV: String, beerIBU: Int, beerUrlString: String, beerDescription: String, breweryName: String?, breweryLocation: String?) {
